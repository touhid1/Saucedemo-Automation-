...
test.describe("🔐 Authentication (Login) - Core Foundation", () => {
  ...
  test("Invalid username + valid password → proper error", async ({
    loginPage,
  }) => {
  ...
  test("Valid username + invalid password → proper error", async ({
    loginPage,
  }) => {
  ...
  test("Empty username + password → validation message", async ({
    loginPage,
  }) => {
  ...
  test("Username filled, password empty → validation message", async ({
    loginPage,
  }) => {
